...
public class DatabaseStorageController : ControllerBase
{
    ...
    public DatabaseStorageController(
        DatabaseStorageService storageService,
        ILogger<DatabaseStorageController> logger)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogError(ex, "Error uploading file to database storage");
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogError(ex, "Error downloading file {FileId} from database storage", id);
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogError(ex, "Error getting metadata for file {FileId} from database storage", id);
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogError(ex, "Error deleting file {FileId} from database storage", id);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error listing files from database storage");
